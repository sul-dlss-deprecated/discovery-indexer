...
describe DiscoveryIndexer::InputXml::PurlxmlParserStrict do
  ...
  describe 'Parse File and Image IDs' do
    ...
    it 'should return image and page ids when present' do
      ...
      expect(pm.parse_file_ids).to eq(["tn629pk3948_sl.mp4", "tn629pk3948_img_1.jp2", "tn629pk3948_img_2.jp2", "tn629pk3948_img_3.jp2", "tn629pk3948_pg_1.jp2", "tn629pk3948_pg_1.pdf"])
    end
  end
